...
Then you can find the processed LMDB file in `zinc15_250K_2D`. You can also find it outputs a `zinc15_250K_2D.pkl`, which determines the order in which the pre-training molecules are read.
